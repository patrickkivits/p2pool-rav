...
BLOCK_EXPLORER_URL_PREFIX = 'http://cryptap.us/uno/explorer/block/'
ADDRESS_EXPLORER_URL_PREFIX = 'http://cryptap.us/uno/explorer/address/'
TX_EXPLORER_URL_PREFIX = 'http://cryptap.us/uno/explorer/tx/'
